"""Minimal LLM access layer: one OpenAI-compatible client and the prompt registry."""
...
from chemex_lit.errors import ConfigurationError, ExternalServiceError, ExtractionError
